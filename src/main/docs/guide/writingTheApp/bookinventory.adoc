...
[source,groovy]
.bookinventory/src/main/groovy/example/micronaut/bookinventory/BookInventory.groovy
----
include::{sourceDir}/bookinventory/src/main/groovy/example/micronaut/bookinventory/BookInventory.groovy[]
----

Write a test:

[source,groovy]
.bookinventory/src/test/groovy/example/micronaut/bookinventory/BooksControllerSpec.groovy
----
include::{sourceDir}/bookinventory/src/test/groovy/example/micronaut/bookinventory/BooksControllerSpec.groovy[]
----
